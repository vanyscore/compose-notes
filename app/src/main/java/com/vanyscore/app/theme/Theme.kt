...
enum class AppTheme {
    ...
    fun toColorScheme(themeType: AppThemeType): ColorScheme {
        return if (themeType == AppThemeType.LIGHT) {
            when (this) {
...
fun ThemeProvider(
    ...
    val themeType = themeState.value.themeType
    val colorScheme = theme.toColorScheme(themeType)
